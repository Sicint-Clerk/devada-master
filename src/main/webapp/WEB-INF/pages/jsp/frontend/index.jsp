...
<html lang="en" class="no-js">
	<head>
		<meta charset="utf-8"/>
		<title>Web Design Development Digital Marketing Agency</title>
		...
		<!--website-favicon-->
		<link href="<%=request.getContextPath()%>/resources/frontend/images/favicon.png" rel="icon">
		<!--plugin-css-->
		<link href="<%=request.getContextPath()%>/resources/frontend/css/bootstrap.min.css" rel="stylesheet">
		<link href="<%=request.getContextPath()%>/resources/frontend/css/plugin.min.css" rel="stylesheet">
		<link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.11.2/css/all.min.css" rel="stylesheet">
		<link href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@400;600;700&family=Poppins:wght@400;500;600;700&display=swap" rel="stylesheet">
		<!-- template-style-->
		<link href="<%=request.getContextPath()%>/resources/frontend/css/style.css" rel="stylesheet">
		<link href="<%=request.getContextPath()%>/resources/frontend/css/responsive.css" rel="stylesheet">
	</head>
	  <body>
<!--Start Header -->
...
<a href="portfolio.html" class="btn-main bg-btn lnk wow fadeIn"  data-wow-delay="0.8s">View Portfolio <i class="fas fa-chevron-right fa-ani"></i><span class="circle"></span></a>
<div class="awards-block-tt  wow fadeIn" data-wow-delay="1s"><img src="<%=request.getContextPath()%>/resources/frontend/images/hero/awards-logo.png" alt="awards-logo" class="img-fluid"/></div>
</div>
</div>
<div class="col-lg-7">
<div class="hero-content-sec wow fadeIn" data-wow-delay="0.8s">
<div class="video-intro-pp"><a class="video-link play-video" href="https://www.youtube.com/watch?v=IQixi4xssVA?autoplay=1&amp;rel=0"><span class="triangle-play"></span></a></div>
...
<div class="hero-service-cards wow fadeInRight" data-wow-duration="2s">
	<div class="owl-carousel service-card-prb">
		<div class="service-slide card-bg-a" data-tilt data-tilt-max="5" data-tilt-speed="1000"><a href="#">
			<div class="service-card-hh">
				<div class="image-sr-mm">
					<img alt="custom-sport" src="<%=request.getContextPath()%>/resources/frontend/images/service/vr.png">
				</div>
		...
		<div class="service-slide card-bg-b" data-tilt data-tilt-max="5" data-tilt-speed="1000"><a href="#">
			<div class="service-card-hh">
				<div class="image-sr-mm">
					<img alt="custom-sport" src="<%=request.getContextPath()%>/resources/frontend/images/service/app-develop.png">
				</div>
		...
		<div class="service-slide card-bg-c" data-tilt data-tilt-max="5" data-tilt-speed="1000"><a href="#">
			<div class="service-card-hh">
				<div class="image-sr-mm">
					<img alt="custom-sport" src="<%=request.getContextPath()%>/resources/frontend/images/service/startup.png">
				</div>
		...
		<div class="service-slide card-bg-d" data-tilt data-tilt-max="5" data-tilt-speed="1000"><a href="#">
			<div class="service-card-hh">
				<div class="image-sr-mm">
					<img alt="custom-sport" src="<%=request.getContextPath()%>/resources/frontend/images/service/car-rental.png">
				</div>
		...
		<div class="service-slide card-bg-e" data-tilt data-tilt-max="5" data-tilt-speed="1000"><a href="#">
			<div class="service-card-hh">
				<div class="image-sr-mm">
					<img alt="custom-sport" src="<%=request.getContextPath()%>/resources/frontend/images/service/marketing.png">
				</div>
		...
		<div class="service-slide card-bg-f" data-tilt data-tilt-max="5" data-tilt-speed="1000"><a href="#">
			<div class="service-card-hh">
				<div class="image-sr-mm">
					<img alt="custom-sport" src="<%=request.getContextPath()%>/resources/frontend/images/service/ewallet.png">
				</div>
...
<img src="<%=request.getContextPath()%>/resources/frontend/images/icons/development.svg" alt="service">
...
<img src="<%=request.getContextPath()%>/resources/frontend/images/icons/ecommerce.svg" alt="service">
...
<img src="<%=request.getContextPath()%>/resources/frontend/images/icons/app.svg" alt="service">
...
<img src="<%=request.getContextPath()%>/resources/frontend/images/icons/tech.svg" alt="service">
...
<img src="<%=request.getContextPath()%>/resources/frontend/images/icons/seo.svg" alt="service">
...
<a href="contact.html" class="btn-main bg-btn3 lnk">Hire Now<i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
</div>
</div>
</div>
</section>
...
<div data-tilt data-tilt-max="20" data-tilt-speed="1000" class="statistics-img">
	<img src="<%=request.getContextPath()%>/resources/frontend/images/icons/startup.svg" alt="years" class="img-fluid" />
</div>
<div class="statnumb">
...
<div class="statistics">
<div data-tilt data-tilt-max="20" data-tilt-speed="1000" class="statistics-img">
	<img src="<%=request.getContextPath()%>/resources/frontend/images/icons/team.svg" alt="team" class="img-fluid" />
</div>
<div class="statnumb">
...
<div class="statistics">
<div data-tilt data-tilt-max="20" data-tilt-speed="1000" class="statistics-img">
	<img src="<%=request.getContextPath()%>/resources/frontend/images/icons/deal.svg" alt="happy" class="img-fluid" />
</div>
<div class="statnumb">
...
<div class="statistics">
<div data-tilt data-tilt-max="20" data-tilt-speed="1000" class="statistics-img">
	<img src="<%=request.getContextPath()%>/resources/frontend/images/icons/computers.svg" alt="project" class="img-fluid" />
</div>
...
<div class="statistics">
<div data-tilt data-tilt-max="20" data-tilt-speed="1000" class="statistics-img">
	<img src="<%=request.getContextPath()%>/resources/frontend/images/icons/worker.svg" alt="work" class="img-fluid" />
</div>
<div class="statnumb">
...
<div data-tilt data-tilt-max="20" data-tilt-speed="1000" class="statistics-img">
	<img src="<%=request.getContextPath()%>/resources/frontend/images/icons/customer-service.svg" alt="support" class="img-fluid" />
</div>
<div class="statnumb">
...
<div class="itm-media-object mt40">
	<div class="media">
		<img src="<%=request.getContextPath()%>/resources/frontend/images/icons/computers.svg" alt="icon">
	...
	<div class="media mt40">
		<img src="<%=request.getContextPath()%>/resources/frontend/images/icons/worker.svg" alt="icon">
		<div class="media-body">
	...
	<div class="media mt40">
		<img src="<%=request.getContextPath()%>/resources/frontend/images/icons/deal.svg" alt="icon">
		<div class="media-body">
...
<div class="col-lg-6">
<div  data-tilt data-tilt-max="5" data-tilt-speed="1000" class="single-image bg-shape-dez wow fadeIn" data-wow-duration="2s"><img src="<%=request.getContextPath()%>/resources/frontend/images/about/about-company.jpg" alt="image" class="img-fluid"></div>
...
<a href="#" class="btn-main bg-btn3 lnk mt30">Request A Quote    <i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
</div>
</div>
</div>
</div>
...
<!--Start Clients-->
<section class="clients-section- bg-gradient15 pt-5 pb-2">
...
<ul class="row text-center clearfix clients-slider owl-carousel">
	<li class="col-lg-12 col-md-12 col-sm-12 col-12 wow fadeIn mb-2" data-wow-delay=".2s">
		<div class="brand-logo"><img src="<%=request.getContextPath()%>/resources/frontend/images/client/clients-1.png" alt="clients" class="img-fluid"></div>
		<p>Shutter, USA</p>
	</li>
	<li class="col-lg-12 col-md-12 col-sm-12 col-12 wow fadeIn mb-2" data-wow-delay=".2s">
		<div class="brand-logo"><img src="<%=request.getContextPath()%>/resources/frontend/images/client/clients-2.png" alt="clients" class="img-fluid"></div>
		<p>Hipster, USA</p>
	</li>
	<li class="col-lg-12 col-md-12 col-sm-12 col-12 wow fadeIn mb-2" data-wow-delay=".2s">
		<div class="brand-logo"><img src="<%=request.getContextPath()%>/resources/frontend/images/client/clients-3.png" alt="clients" class="img-fluid"></div>
		<p>Happy, USA</p>
	</li>
	<li class="col-lg-12 col-md-12 col-sm-12 col-12 wow fadeIn mb-2" data-wow-delay=".2s">
		<div class="brand-logo"><img src="<%=request.getContextPath()%>/resources/frontend/images/client/clients-4.png" alt="clients" class="img-fluid"></div>
		<p>Opera Tours, USA</p>
	</li>
	<li class="col-lg-12 col-md-12 col-sm-12 col-12 wow fadeIn mb-2" data-wow-delay=".2s">
		<div class="brand-logo"><img src="<%=request.getContextPath()%>/resources/frontend/images/client/clients-5.png" alt="clients" class="img-fluid"></div>
		<p>Royale Stone, UK</p>
	</li>
	<li class="col-lg-12 col-md-12 col-sm-12 col-12 wow fadeIn mb-2" data-wow-delay=".2s">
		<div class="brand-logo"><img src="<%=request.getContextPath()%>/resources/frontend/images/client/clients-6.png" alt="clients" class="img-fluid"></div>
		<p>QTP, Australia</p>
	</li>
	<li class="col-lg-12 col-md-12 col-sm-12 col-12 wow fadeIn mb-2" data-wow-delay=".2s">
		<div class="brand-logo"><img src="<%=request.getContextPath()%>/resources/frontend/images/client/clients-7.png" alt="clients" class="img-fluid"></div>
		<p>PAPA, Malaysia</p>
	</li>
	<li class="col-lg-12 col-md-12 col-sm-12 col-12 wow fadeIn mb-2" data-wow-delay=".2s">
		<div class="brand-logo"><img src="<%=request.getContextPath()%>/resources/frontend/images/client/clients-8.png" alt="clients" class="img-fluid"></div>
		<p>Coffee, Australia</p>
	</li>
	<li class="col-lg-12 col-md-12 col-sm-12 col-12 wow fadeIn mb-2" data-wow-delay=".2s">
		<div class="brand-logo"><img src="<%=request.getContextPath()%>/resources/frontend/images/client/clients-9.png" alt="clients" class="img-fluid"></div>
		<p>Bakery, India</p>
	</li>
	<li class="col-lg-12 col-md-12 col-sm-12 col-12 wow fadeIn mb-2" data-wow-delay=".2s">
		<div class="brand-logo"><img src="<%=request.getContextPath()%>/resources/frontend/images/client/clients-10.png" alt="clients" class="img-fluid"></div>
		<p>Iconico, India</p>
	</li>
	<li class="col-lg-12 col-md-12 col-sm-12 col-12 wow fadeIn mb-2" data-wow-delay=".2s">
		<div class="brand-logo"><img src="<%=request.getContextPath()%>/resources/frontend/images/client/clients-11.png" alt="clients" class="img-fluid"></div>
		<p>Tom N Jerry, UK</p>
	</li>
	<li class="col-lg-12 col-md-12 col-sm-12 col-12 wow fadeIn mb-2" data-wow-delay=".2s">
		<div class="brand-logo"><img src="<%=request.getContextPath()%>/resources/frontend/images/client/clients-12.png" alt="clients" class="img-fluid"></div>
		<p>Arch, India</p>
	</li>
	<li class="col-lg-12 col-md-12 col-sm-12 col-12 wow fadeIn mb-2" data-wow-delay=".2s">
		<div class="brand-logo"><img src="<%=request.getContextPath()%>/resources/frontend/images/client/clients-13.png" alt="clients" class="img-fluid"></div>
		<p>Aro Group, India</p>
	</li>
	<li class="col-lg-12 col-md-12 col-sm-12 col-12 wow fadeIn mb-2" data-wow-delay=".2s">
		<div class="brand-logo"><img src="<%=request.getContextPath()%>/resources/frontend/images/client/clients-14.png" alt="clients" class="img-fluid"></div>
		<p>Tom Group, India</p>
	</li>
	<li class="col-lg-12 col-md-12 col-sm-12 col-12 wow fadeIn mb-2" data-wow-delay=".2s">
		<div class="brand-logo"><img src="<%=request.getContextPath()%>/resources/frontend/images/client/clients-4.png" alt="clients" class="img-fluid"></div>
...
<div data-tilt data-tilt-max="20" data-tilt-speed="600" class="icon-set wow fadeIn" data-wow-delay=".2s">
	<div class="work-card cd1">
		<div class="icon-bg"><img src="<%=request.getContextPath()%>/resources/frontend/images/icons/icon-1.png" alt="Industries" /></div>
...
<div data-tilt data-tilt-max="20" data-tilt-speed="600" class="icon-set wow fadeIn" data-wow-delay=".4s">
	<div class="work-card cd2">
		<div class="icon-bg"><img src="<%=request.getContextPath()%>/resources/frontend/images/icons/icon-2.png" alt="Industries" /></div>
...
<div data-tilt data-tilt-max="20" data-tilt-speed="600" class="icon-set wow fadeIn" data-wow-delay=".6s">
	<div class="work-card cd3">
		<div class="icon-bg"><img src="<%=request.getContextPath()%>/resources/frontend/images/icons/icon-3.png" alt="Industries" /></div>
...
<div data-tilt data-tilt-max="20" data-tilt-speed="600" class="icon-set wow fadeIn" data-wow-delay=".8s">
	<div class="work-card cd4">
		<div class="icon-bg"><img src="<%=request.getContextPath()%>/resources/frontend/images/icons/icon-4.png" alt="Industries" /></div>
		<p>Video Service</p>
	</div>
</div>
<div data-tilt data-tilt-max="20" data-tilt-speed="600" class="icon-set wow fadeIn" data-wow-delay="1s">
	<div class="work-card cd5">
		<div class="icon-bg"><img src="<%=request.getContextPath()%>/resources/frontend/images/icons/icon-5.png" alt="Industries" /></div>
		<p>Banking Service</p>
	</div>
</div>
<div data-tilt data-tilt-max="20" data-tilt-speed="600" class="icon-set wow fadeIn" data-wow-delay="1.2s">
	<div class="work-card cd6">
		<div class="icon-bg"><img src="<%=request.getContextPath()%>/resources/frontend/images/icons/icon-6.png" alt="Industries" /></div>
...
<div data-tilt data-tilt-max="20" data-tilt-speed="600" class="icon-set wow fadeIn" data-wow-delay="1.4s">
	<div class="work-card cd7">
		<div class="icon-bg"><img src="<%=request.getContextPath()%>/resources/frontend/images/icons/icon-7.png" alt="Industries" /></div>
...
<div data-tilt data-tilt-max="20" data-tilt-speed="600" class="icon-set wow fadeIn" data-wow-delay="1.6s">
	<div class="work-card cd8">
		<div class="icon-bg"><img src="<%=request.getContextPath()%>/resources/frontend/images/icons/icon-8.png" alt="Industries" /></div>
...
<div data-tilt data-tilt-max="20" data-tilt-speed="600" class="icon-set wow fadeIn" data-wow-delay="1.8s">
	<div class="work-card cd9">
		<div class="icon-bg"><img src="<%=request.getContextPath()%>/resources/frontend/images/icons/icon-9.png" alt="Industries" /></div>
		<p>Health Service</p>
	</div>
</div>
<div data-tilt data-tilt-max="20" data-tilt-speed="600" class="icon-set wow fadeIn" data-wow-delay="2s">
	<div class="work-card cd10">
		<div class="icon-bg"><img src="<%=request.getContextPath()%>/resources/frontend/images/icons/icon-10.png" alt="Industries" /></div>
		<p>Event & Ticket</p>
	</div>
</div>
<div data-tilt data-tilt-max="20" data-tilt-speed="600" class="icon-set wow fadeIn" data-wow-delay="2.2s">
	<div class="work-card cd11">
		<div class="icon-bg"><img src="<%=request.getContextPath()%>/resources/frontend/images/icons/icon-11.png" alt="Industries" /></div>
...
<div data-tilt data-tilt-max="20" data-tilt-speed="600" class="icon-set wow fadeIn" data-wow-delay="2.4s">
	<div class="work-card cd12">
		<div class="icon-bg"><img src="<%=request.getContextPath()%>/resources/frontend/images/icons/icon-12.png" alt="Industries" /></div>
		...
		<div class="testimonial-card">
			...
			<div class="client-thumbs mt30">
				<div class="media v-center">
					<div class="user-image bdr-radius"><img src="<%=request.getContextPath()%>/resources/frontend/images/user-thumb/girl.jpg" alt="girl" class="img-fluid" /></div>
...
<div class="col-lg-12">
	<div class="review-ref mt100">
		...
		<div class="review-icons">
			<a href="#" target="blank" class="wow fadeIn" data-wow-delay=".2s"><img src="<%=request.getContextPath()%>/resources/frontend/images/about/reviews-icon-1.png" alt="review" class="img-fluid"></a>
			<a href="#" target="blank" class="wow fadeIn" data-wow-delay=".4s"><img src="<%=request.getContextPath()%>/resources/frontend/images/about/reviews-icon-2.png" alt="review" class="img-fluid"></a>
			<a href="#" target="blank" class="wow fadeIn" data-wow-delay=".6s"><img src="<%=request.getContextPath()%>/resources/frontend/images/about/reviews-icon-3.png" alt="review" class="img-fluid"></a>
		</div>
	</div>
</div>
</div>
...
<div class="col-lg-4 col-sm-6 shape-loc wow fadeInUp" data-wow-delay=".2s">
	<div class="office-card">
		<div class="skyline-img" data-tilt data-tilt-max="4" data-tilt-speed="1000">
			<img src="<%=request.getContextPath()%>/resources/frontend/images/location/newyork.png" alt="New York" class="img-fluid" />
		</div>
...
<div class="col-lg-4 col-sm-6 shape-loc wow fadeInUp" data-wow-delay=".5s">
	<div class="office-card">
		<div class="skyline-img" data-tilt data-tilt-max="4" data-tilt-speed="1000">
			<img src="<%=request.getContextPath()%>/resources/frontend/images/location/sydeny.png" alt="sydney" class="img-fluid" />
		</div>
		<div class="office-text">
			<h4>Sydney</h4>
	...
	<div class="col-lg-4 col-sm-6 shape-loc wow fadeInUp" data-wow-delay=".8s">
		<div class="office-card mb0">
			<div class="skyline-img" data-tilt data-tilt-max="4" data-tilt-speed="1000">
				<img src="<%=request.getContextPath()%>/resources/frontend/images/location/rome.png" alt="rome" class="img-fluid" />
			</div>
			<div class="office-text">
				<h4>Rome</h4>
...
<script src="<%=request.getContextPath()%>/resources/frontend/js/vendor/modernizr-3.5.0.min.js"></script>
<script src="<%=request.getContextPath()%>/resources/frontend/js/jquery.min.js"></script>
<script src="<%=request.getContextPath()%>/resources/frontend/js/bootstrap.min.js"></script>
<script src="<%=request.getContextPath()%>/resources/frontend/js/popper.min.js"></script>
<script src="<%=request.getContextPath()%>/resources/frontend/js/plugin.min.js"></script>
<!--common script file-->
<script src="<%=request.getContextPath()%>/resources/frontend/js/main.js"></script>
</body>
</html>