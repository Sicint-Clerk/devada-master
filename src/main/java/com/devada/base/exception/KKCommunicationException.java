 ...
 */
public class KKCommunicationException extends KKSystemException {
   ...
   */
  public KKCommunicationException(ResultCode resultCode) {
    super(resultCode);
  }
   ...
   * 
   */
  public KKCommunicationException(ResultCode resultCode, int severityType) {
   ...
   * 
   */
  public KKCommunicationException(ResultCode resultCode, Throwable cause) {
   ...
   * 
   */
  public KKCommunicationException(ResultCode resultCode, int severityType, Throwable cause) {
   ...
   */
  public KKCommunicationException(ResultCode resultCode, String... msgArgs) {
   ...
   *          {@link String} contain error message arguments
   */
  public KKCommunicationException(ResultCode resultCode, int severityType, String... msgArgs) {
   ...
   *          {@link String} contain error message arguments
   */
  public KKCommunicationException(ResultCode resultCode, Throwable cause, String... msgArgs) {
