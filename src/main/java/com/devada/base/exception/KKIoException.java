 ...
 */
public class KKIoException extends KKSystemException {
   ...
   */
  public KKIoException(ResultCode resultCode) {
    super(resultCode);
  }
   ...
   * 
   */
  public KKIoException(ResultCode resultCode, int severityType) {
   ...
   * 
   */
  public KKIoException(ResultCode resultCode, Throwable cause) {
   ...
   * 
   */
  public KKIoException(ResultCode resultCode, int severityType, Throwable cause) {
   ...
   */
  public KKIoException(ResultCode resultCode, String... msgArgs) {
   ...
   *          {@link String} contain error message arguments
   */
  public KKIoException(ResultCode resultCode, int severityType, String... msgArgs) {
   ...
   *          {@link String} contain error message arguments
   */
  public KKIoException(ResultCode resultCode, Throwable cause, String... msgArgs) {
