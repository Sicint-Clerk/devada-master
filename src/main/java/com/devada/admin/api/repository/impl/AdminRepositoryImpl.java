...
import com.devada.admin.api.dao.MainServiceDao;
...
import com.devada.admin.api.dao.SubServiceDao;
...
import com.devada.admin.api.entity.MainService;
...
import com.devada.admin.api.entity.SubService;
...
public class AdminRepositoryImpl<E> implements AdminRepository {
  ...
  @Autowired
  private MainServiceDao myMainServiceDao;
  
  @Autowired
  private SubServiceDao mySubServiceDao;
  ...
  public List<PersonInformation> getPersonInformation() throws KKDaoException {
    try {
      ...
      throw new KKDaoException(AdminErrorCodes.ADMIN_DAO_CATEGORY_GET_ILLEGAL_ARGUMENT_EXCEPTION,
          ex);
    }
  }

  @Override
  public PersonInformation savePersonInformation(PersonInformation personInformation)
      throws KKDaoException {
    try {
      ...
      throw new KKDaoException(AdminErrorCodes.ADMIN_DAO_CATEGORY_SAVE_ILLEGAL_ARGUMENT_EXCEPTION,
          ex);
    }
  }

  public FamilyInformation saveFamilyInformation(FamilyInformation familyInformation)
      throws KKDaoException {
    try {
  ...
  public List<FamilyInformation> getFamilyInformationByPersonKey(Integer id) throws KKDaoException {
    try {
      List<FamilyInformation> tempList =
          familyInformationDao.findEntitiesByColumn(FamilyInformation.class, "personKey", id);
      return tempList;
  ...
  public List<PersonInformation> getApprovedList() throws KKDaoException {
    try {
      List<PersonInformation> informations =
          personInformationDao.findEntitiesByColumn(PersonInformation.class, "isApproved", "Y");
      return informations;
    } catch (IllegalStateException ex) {
      throw new KKDaoException(AdminErrorCodes.ADMIN_DAO_CATEGORY_GET_ILLEGAL_STATE_EXCEPTION, ex);
    } catch (IllegalArgumentException ex) {
  ...
  public PersonInformation findEmailId(String emailid) throws Exception {
    List<PersonInformation> personInformation =
        personInformationDao.findEntitiesByColumn(PersonInformation.class, "email", emailid);
    return personInformation.get(0);
  }

  @Override
  public MarriageInformation saveMarriageInformation(MarriageInformation marriageInformation)
      throws Exception {
    try {
  ...
  public List<MarriedDaughter> getMarriedDaughter(Integer id) throws KKDaoException {
    List<MarriedDaughter> informations =
        marriedDaughterDao.findEntitiesByColumn(MarriedDaughter.class, "marriegeKey",id);
    return informations;
  }
	...
	@Override
	public MainService saveMainService(MainService myMainService) throws KKDaoException {
		// TODO Auto-generated method stub
		try {
			return  myMainServiceDao.save(myMainService);
		} catch (IllegalStateException ex) {
		      throw new KKDaoException(AdminErrorCodes.ADMIN_DAO_CATEGORY_SAVE_ILLEGAL_STATE_EXCEPTION, ex);
		} catch (IllegalArgumentException ex) {
	...
	@Override
	public SubService saveSubService(SubService mySubService) throws KKDaoException {
		// TODO Auto-generated method stub
		try {
			return  mySubServiceDao.save(mySubService);
		} catch (IllegalStateException ex) {
		      throw new KKDaoException(AdminErrorCodes.ADMIN_DAO_CATEGORY_SAVE_ILLEGAL_STATE_EXCEPTION, ex);
		} catch (IllegalArgumentException ex) {
		      throw new KKDaoException(AdminErrorCodes.ADMIN_DAO_CATEGORY_SAVE_ILLEGAL_ARGUMENT_EXCEPTION, ex);
